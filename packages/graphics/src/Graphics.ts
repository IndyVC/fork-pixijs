...
export class Graphics extends Container {
    ...
    public lineStyle(
        options: ILineStyleOptions | number = null,
    ...
    public arcTo(
        ...
        if (result) {
            const { cx, cy, radius, startAngle, endAngle, anticlockwise } =
                result;
    ...
    private normalizeColor(
        options: Pick<IFillStyleOptions, "color" | "alpha">
    ): void {
    ...
    /**
     * Draw a dashed line
     * @param x - The X coordinate where the line should move to
     * @param y - The Y coordinate where the line should move to
     * @param dash - The length of each dash
     * @param gap - The gap between each dash
     */
    public drawDashedLine(x: number, y: number, dash = 16, gap = 8) {
        ...
        let inverseX = x < currentPosition.x;
        let inverseY = y < currentPosition.y;
        let conditionX = () =>
            inverseX
    ...
    /**
     * Draw a rectangle with a dashed border instead of solid
     * @param x - The X coord of the top-left of the rectangle
     * @param y - The Y coord of the top-left of the rectangle
     * @param width - The width of the rectangle
     * @param height - The height of the rectangle
    ...
    public drawDashedRect(
        ...
        this.drawDashedLine(x + width, y, dash, gap);
        this.drawDashedLine(x + width, y + height, dash, gap);
        this.drawDashedLine(x, y + height, dash, gap);
        this.drawDashedLine(x, y, dash, gap);
    }
